...
//LED, By Prabhat Chandra On 15-Oct-2017
int led2 = 13;
...
//LPG, By Prabhat Chandra On 15-Oct-2017
...
void setup() {
  ...
  // BLUETOOTH put your setup code here, to run once:
 ...
 //Bluetooth
   Genotronex.println("Fault Management System");
...
if ((temp) > 35) {
    ...
    lcd.setCursor(0,1);
    lcd.print("HIGH TEMP");
    Genotronex.println("ALERT!!! THE TEMPERATURE HAS CROSSED THRESHOLD VALUE");
    
}  if((MQGetGasPercentage(MQRead(MQ_PIN) / Ro, GAS_LPG)) || (MQGetGasPercentage(MQRead(MQ_PIN) / Ro, GAS_CH4)) > 1) {
          Genotronex.println("ALERT!!! THE GAS IS LEAKING");
          Serial.print("Warning!!!");
          digitalWrite(led2, HIGH);
          lcd.setCursor(0,0);
...
//SOURCE CODE FOR GAS AND TEMPERATURE DECDECTOR
